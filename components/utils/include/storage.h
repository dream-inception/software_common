 ...
 *     - ESP_OK
 */
esp_err_t storage_set(const char *key, const void *value, size_t length);

/**
 * @brief  Load the information,
 *         esp_err_t storage_load(const char *key, void *value, size_t *length);
 *         esp_err_t storage_load(const char *key, void *value, size_t length);
 *
 ...
 *     - ESP_OK
 */
esp_err_t storage_get(const char *key, void *value, size_t length);
